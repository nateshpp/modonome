...
Merkle root: sha256:60227d90c63e5b62455dad752ce46b3077ddb36c0a4eb19883ff9b0880ea4cab
Files: 774  Bytes: 2525455  Map tokens: 89841/120000
...
- S:87c8d03eb8 function dirsFromCodeowners `function dirsFromCodeowners()` L97 : 4. The two protected-path surfaces must agree. CODEOWNERS is what GitHub enforces; protected_paths_extra is what the engine reads. If they disagree, a path is protected in name only (the bin/ gap that
...
- S:e3c36060ec function makeMinimalRepo `function makeMinimalRepo()` L84 : Build a minimal passing temp repo and return the path. Caller must rmSync(tmp, {recursive:true}).
- S:7c9eb8f22d function runScript `function runScript(tmp)` L102
- S:43cc2b28a1 function withStubRunner `function withStubRunner(tmp, score, extendedScore, totalScore)` L216
...
- S:2cb05d3887 function git `function git(args, opts = {})` L36
- S:05ff801d3e function currentBranch `function currentBranch()` L41
- S:fc3bb4bc24 function collectFindings `function collectFindings()` L48 : Collect findings for the current branch, the commits unique to it, and the PR-body-shaped surfaces we can see locally (the commit bodies themselves).
- S:400a8c02c3 function applyFix `function applyFix(branch, findings)` L74
- S:6fab505fa4 function parsePrNumber `function parsePrNumber(rest)` L95 : Parse an optional `--pr <n>` flag. Returns the positive integer PR number, or null when absent. Throws on a malformed value so the caller can report it.
- S:cde4a28e06 function collectPrFindings `async function collectPrFindings(prNumber, client = createGitHubClient())` L110 : Fetch the PR title, body, and conversation comments and scan them with the strict detector. Uses the same AI_SIGNATURE_RE as every other surface, so this is a hard detection gate, not the advisory nea
- S:c546f7913f function main `async function main(argv)` L121
...
1. design-system/src/lib/cx.ts centrality=32 pagerank=0.03773
2. design-system/src/components/Icon/Icon.tsx centrality=23 pagerank=0.02446
3. design-system/src/index.ts centrality=48 pagerank=0.000992
4. design-system/src/components/HelpHint/HelpHint.tsx centrality=12 pagerank=0.008324
5. apps/control-panel/src/state/types.ts centrality=12 pagerank=0.008315
6. scripts/lib/yaml-lite.mjs centrality=12 pagerank=0.007905
7. scripts/agent/run-cycle.mjs centrality=17 pagerank=0.003732
8. scripts/lib/jsonschema.mjs centrality=8 pagerank=0.010779
9. design-system/src/components/StatusPill/StatusPill.tsx centrality=12 pagerank=0.005934
10. scripts/lib/learnings.mjs centrality=9 pagerank=0.007183
11. scripts/validate-config.mjs centrality=11 pagerank=0.004667
12. scripts/lib/snapshot-core.mjs centrality=13 pagerank=0.00166
13. design-system/src/components/Button/Button.tsx centrality=9 pagerank=0.004786
14. scripts/lib/canonical-json.mjs centrality=8 pagerank=0.005169
15. design-system/src/components/IconButton/IconButton.tsx centrality=6 pagerank=0.005552
16. apps/control-panel/src/App.tsx centrality=11 pagerank=0.001414
17. design-system/src/components/WorkItemCard/WorkItemCard.tsx centrality=8 pagerank=0.002899
18. scripts/validate-knowledge-packet.mjs centrality=7 pagerank=0.003581
19. scripts/lib/secret-patterns.mjs centrality=4 pagerank=0.005164
20. design-system/src/tokens/tokens.ts centrality=6 pagerank=0.003468
21. scripts/validate-work-item.mjs centrality=6 pagerank=0.003381
22. scripts/lib/lang-adapters/index.mjs centrality=8 pagerank=0.00166
23. apps/control-panel/src/lib/confirm.tsx centrality=6 pagerank=0.00316
24. design-system/src/components/Tooltip/Tooltip.tsx centrality=3 pagerank=0.005388
25. scripts/agent/resolve-role.mjs centrality=6 pagerank=0.002897
26. design-system/src/components/WorkItemDrawer/WorkItemDrawer.tsx centrality=7 pagerank=0.00185
27. scripts/snapshot.mjs centrality=8 pagerank=0.000992
28. scripts/lib/graph.mjs centrality=4 pagerank=0.004063
29. design-system/src/components/Card/Card.tsx centrality=5 pagerank=0.002899
30. design-system/src/lib/format.ts centrality=5 pagerank=0.002897
31. design-system/src/components/LeaseTable/LeaseTable.tsx centrality=6 pagerank=0.00185
32. scripts/agent/providers.mjs centrality=3 pagerank=0.003953
33. apps/control-panel/src/state/adapter.ts centrality=6 pagerank=0.001112
34. design-system/src/components/ActivationLadder/ActivationLadder.tsx centrality=5 pagerank=0.00185
35. design-system/src/components/CostPanel/CostPanel.tsx centrality=5 pagerank=0.00185
36. design-system/src/components/GatePanel/GatePanel.tsx centrality=5 pagerank=0.00185
37. design-system/src/components/ProtectedPathRow/ProtectedPathRow.tsx centrality=5 pagerank=0.00185
38. design-system/src/components/Modal/Modal.tsx centrality=4 pagerank=0.002636
39. design-system/src/components/TierBadge/TierBadge.tsx centrality=4 pagerank=0.002605
40. examples/demo-app/src/index.js centrality=6 pagerank=0.000992
41. design-system/src/components/Table/Table.tsx centrality=4 pagerank=0.002558
42. apps/control-panel/server/learningsFormat.mjs centrality=2 pagerank=0.004004
43. design-system/src/components/IdentityChip/IdentityChip.tsx centrality=4 pagerank=0.002427
44. scripts/lib/control-panel-audit.mjs centrality=3 pagerank=0.003079
45. scripts/lib/branch-name.mjs centrality=3 pagerank=0.003037
46. scripts/lib/commit-identity.mjs centrality=3 pagerank=0.003037
47. design-system/src/components/ArmingStateBadge/ArmingStateBadge.tsx centrality=4 pagerank=0.00185
48. design-system/src/components/Checkbox/Checkbox.tsx centrality=4 pagerank=0.00185
49. design-system/src/components/DecisionCard/DecisionCard.tsx centrality=4 pagerank=0.00185
50. design-system/src/components/Input/Input.tsx centrality=4 pagerank=0.00185
